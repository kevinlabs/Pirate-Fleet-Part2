...
struct Settings {
    ...
    struct Messages {
        ...
        static let GameOverLose = "You've been defeated by the terminator. (SKYNET)"
        ...
        static let HumanHitMonster = "You've hit a sea monster! Your ship will BURRRNNNNNNNNN Feel the BERNIE!!"
        static let ComputerHitMonster = "The computer has hit a sea monster! THEIR SHIP WILL BURNNNNNN :D ."
